        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessMail = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingMethodName = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    minimumsepettutari = table.Column<double>(type: "REAL", nullable: true),
                    DPercentage = table.Column<double>(type: "REAL", nullable: true),
                    DPrice = table.Column<double>(type: "REAL", nullable: true),
                    xProduct = table.Column<double>(type: "REAL", nullable: true),
                    yProduct = table.Column<double>(type: "REAL", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deals_Shippings_ShippingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SoldId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    OrderId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Solds_AspNetUsers_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Solds_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Solds_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProductLists_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProductLists_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderIdLink = table.Column<string>(type: "TEXT", nullable: true),
                    SoldIdLink = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solds_OrderId",
                table: "Solds",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Solds_SellerId",
                table: "Solds",
                column: "SellerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProductLists_UserId",
                table: "UserProductLists",
                column: "UserId");
